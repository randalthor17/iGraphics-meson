 ...
 * Provides functions to initialize the font system, render text at specified
 * positions, and free resources. This library is designed to be easy to use for
 * beginners and supports basic text rendering operations. It includes features
 * like loading fonts, rendering text with OpenGL textures, and managing font
 * resources.
 *
...
void iShowText(double x, double y, const char *text, const char *fontPath,
               int fontSize = 32) {
  if (!iInitializeFont()) {
